// src/app/dashboard/tienda/nosotros/page.js
'use client';
...
import AboutSection from '@/components/tienda/nosotros/AboutSection';
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Estamos preparando la sección Nosotros
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Completa la configuración de tu tienda para gestionar la sección Nosotros
          </p>
          <a
            href="/dashboard/configuracion"
