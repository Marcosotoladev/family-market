...
export default function HeroCarousel() {
  ...
  return (
    <section className="relative w-full h-40 sm:h-44 md:h-52 lg:h-60 xl:h-72 overflow-hidden bg-gray-900 dark:bg-gray-950 rounded-lg sm:rounded-xl lg:rounded-2xl mx-auto">
      {/* Slides */}
