// src/components/profile/BusinessInfoSection.js
'use client';
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Puedes cambiarlo en la sección "Fotos y Logos"
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-b-lg sm:rounded-b-none sm:rounded-r-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-w-0"
